@extends('livewire.layout.main', ['title' => 'Crear Posts'])
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">Crear Posts</h4>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-box">
                        <div class="row">
                            <div class="col-xl-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="checkbox checkbox-success checkbox-circle mb-2">
                                        <input id="status-10" name="status" type="checkbox">
                                        <label for="status-10">
                                            Publicado
                                        </label>
                                    </div>
                            ...
                            <div class="col-xl-12">
                                ...
                                @enderror
                                <div class="form-group">
                                    <textarea id="body" name="body" class="form-control @error('image') is-invalid @enderror" placeholder="Escribe el contenido de tu post aqui!"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-3">
